        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Real-time validation and distribution of malicious indicators. Protect your infrastructure with actionable
              threat intelligence.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="p-6 rounded-lg border border-border bg-card space-y-3">
              ...
              <p className="text-muted-foreground">Automated validation of threat indicators from multiple sources</p>
            </div>

            <div className="p-6 rounded-lg border border-border bg-card space-y-3">
              <Globe className="h-10 w-10 text-primary" />
              <h3 className="text-xl font-semibold">Global Coverage</h3>
              <p className="text-muted-foreground">Track malicious IPs and domains across the globe</p>
            </div>

            <div className="p-6 rounded-lg border border-border bg-card space-y-3">
              <TrendingUp className="h-10 w-10 text-primary" />
              <h3 className="text-xl font-semibold">API Access</h3>
              <p className="text-muted-foreground">Easy integration with your security infrastructure</p>
            </div>
          </div>
        </div>
      </main>
